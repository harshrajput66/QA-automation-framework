...
# Timeouts
DEFAULT_TIMEOUT = 30000  # 30 seconds for Playwright
API_TIMEOUT = 10  # 10 seconds for requests

# Playwright settings
HEADLESS = os.environ.get("QA_HEADLESS", "true").lower() == "true"
SLOW_MO = int(os.environ.get("QA_SLOW_MO", "0"))
BROWSER = os.environ.get("QA_BROWSER", "chromium")  # chromium, firefox, webkit
